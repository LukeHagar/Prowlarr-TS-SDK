...
export type SDKOptions = {
  ...
  /**
   * Sets the hostpath variable for url substitution
   */
  ...
  const serverParams: Params[] = [
    {
      ...
      "hostpath": options.hostpath ?? "localhost:9696",
    },
  ];
  let params: Params = {};
...
export const SDK_METADATA = {
  ...
  sdkVersion: "0.1.1",
  genVersion: "2.677.3",
  userAgent: "speakeasy-sdk/typescript 0.1.1 2.677.3 1.0.0 prowlarr",
} as const;
