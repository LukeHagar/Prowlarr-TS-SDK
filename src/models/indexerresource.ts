...
import {
  ...
  IndexerCapabilityResource$inboundSchema,
  IndexerCapabilityResource$Outbound,
  IndexerCapabilityResource$outboundSchema,
} from "./indexercapabilityresource.js";
import {
  IndexerPrivacy,
...
export type IndexerResource = {
  ...
  presets?: Array<IndexerResource> | null | undefined;
  ...
  capabilities?: IndexerCapabilityResource | undefined;
...
/** @internal */
export const IndexerResource$inboundSchema: z.ZodType<
  IndexerResource,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  presets: z.nullable(z.array(z.lazy(() => IndexerResource$inboundSchema)))
    .optional(),
  ...
  capabilities: IndexerCapabilityResource$inboundSchema.optional(),
...
/** @internal */
export type IndexerResource$Outbound = {
  id?: number | undefined;
  name?: string | null | undefined;
  ...
  tags?: Array<number> | null | undefined;
  presets?: Array<IndexerResource$Outbound> | null | undefined;
  indexerUrls?: Array<string> | null | undefined;
  legacyUrls?: Array<string> | null | undefined;
  definitionName?: string | null | undefined;
  description?: string | null | undefined;
  ...
  capabilities?: IndexerCapabilityResource$Outbound | undefined;
  priority?: number | undefined;
  downloadClientId?: number | undefined;
...
/** @internal */
export const IndexerResource$outboundSchema: z.ZodType<
  IndexerResource$Outbound,
  z.ZodTypeDef,
  IndexerResource
> = z.object({
  id: z.number().int().optional(),
  ...
  tags: z.nullable(z.array(z.number().int())).optional(),
  presets: z.nullable(z.array(z.lazy(() => IndexerResource$outboundSchema)))
    .optional(),
  indexerUrls: z.nullable(z.array(z.string())).optional(),
  legacyUrls: z.nullable(z.array(z.string())).optional(),
  definitionName: z.nullable(z.string()).optional(),
  ...
  capabilities: IndexerCapabilityResource$outboundSchema.optional(),
  priority: z.number().int().optional(),
  downloadClientId: z.number().int().optional(),
 ...
 */
export namespace IndexerResource$ {
  /** @deprecated use `IndexerResource$inboundSchema` instead. */
  export const inboundSchema = IndexerResource$inboundSchema;
  /** @deprecated use `IndexerResource$outboundSchema` instead. */
  export const outboundSchema = IndexerResource$outboundSchema;
  /** @deprecated use `IndexerResource$Outbound` instead. */
  export type Outbound = IndexerResource$Outbound;
}

export function indexerResourceToJSON(
  indexerResource: IndexerResource,
): string {
  return JSON.stringify(IndexerResource$outboundSchema.parse(indexerResource));
}

export function indexerResourceFromJSON(
  jsonString: string,
): SafeParseResult<IndexerResource, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => IndexerResource$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'IndexerResource' from JSON`,
  );
}
