...
import {
  Command,
  Command$inboundSchema,
  Command$Outbound,
  Command$outboundSchema,
} from "./command.js";
import {
  CommandPriority,
...
/** @internal */
export const CommandResource$inboundSchema: z.ZodType<
  CommandResource,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  body: Command$inboundSchema.optional(),
...
/** @internal */
export type CommandResource$Outbound = {
  id?: number | undefined;
  name?: string | null | undefined;
  commandName?: string | null | undefined;
  message?: string | null | undefined;
  body?: Command$Outbound | undefined;
...
/** @internal */
export const CommandResource$outboundSchema: z.ZodType<
  CommandResource$Outbound,
  z.ZodTypeDef,
  CommandResource
> = z.object({
  id: z.number().int().optional(),
  ...
  commandName: z.nullable(z.string()).optional(),
  message: z.nullable(z.string()).optional(),
  body: Command$outboundSchema.optional(),
...
export namespace CommandResource$ {
  /** @deprecated use `CommandResource$inboundSchema` instead. */
  export const inboundSchema = CommandResource$inboundSchema;
  /** @deprecated use `CommandResource$outboundSchema` instead. */
  export const outboundSchema = CommandResource$outboundSchema;
  /** @deprecated use `CommandResource$Outbound` instead. */
  export type Outbound = CommandResource$Outbound;
}

export function commandResourceToJSON(
  commandResource: CommandResource,
): string {
  return JSON.stringify(CommandResource$outboundSchema.parse(commandResource));
}

export function commandResourceFromJSON(
  jsonString: string,
): SafeParseResult<CommandResource, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CommandResource$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CommandResource' from JSON`,
  );
}
