...
export const startCommand = buildCommand({
  ...
  parameters: {
    flags: {
      ...
      protocol: {
        kind: "enum",
        brief: "Sets the protocol variable for url substitution",
        optional: true,
        values: Object.values(ServerProtocol) as Array<ServerProtocol>,
      },
      hostpath: {
        kind: "parsed",
        brief: "Sets the hostpath variable for url substitution",
        optional: true,
        parse: (value) => value,
      },
      "log-level": {
