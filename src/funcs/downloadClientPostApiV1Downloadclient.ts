...
export function downloadClientPostApiV1Downloadclient(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostApiV1DownloadclientRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/downloadclient")();
