...
export function customFilterPostApiV1Customfilter(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.CustomFilterResource$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v1/customfilter")();
