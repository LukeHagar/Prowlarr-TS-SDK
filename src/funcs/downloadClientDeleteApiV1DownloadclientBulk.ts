...
export function downloadClientDeleteApiV1DownloadclientBulk(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.DownloadClientBulkResource$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v1/downloadclient/bulk")();
