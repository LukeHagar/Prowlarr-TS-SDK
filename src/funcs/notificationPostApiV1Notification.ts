...
export function notificationPostApiV1Notification(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostApiV1NotificationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/notification")();
