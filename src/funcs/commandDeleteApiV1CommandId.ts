...
export function commandDeleteApiV1CommandId(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteApiV1CommandIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/command/{id}")(pathParams);
