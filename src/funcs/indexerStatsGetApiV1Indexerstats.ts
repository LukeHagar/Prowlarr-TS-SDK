...
export function indexerStatsGetApiV1Indexerstats(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApiV1IndexerstatsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/indexerstats")();
