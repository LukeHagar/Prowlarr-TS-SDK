...
export function customFilterPutApiV1CustomfilterId(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutApiV1CustomfilterIdRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CustomFilterResource, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/v1/customfilter/{id}")(pathParams);
