...
export function taskGetApiV1SystemTaskId(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApiV1SystemTaskIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/system/task/{id}")(pathParams);
