...
export function newznabGetApiV1IndexerIdNewznab(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApiV1IndexerIdNewznabRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/indexer/{id}/newznab")(pathParams);
