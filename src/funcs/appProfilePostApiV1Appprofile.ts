...
export function appProfilePostApiV1Appprofile(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.AppProfileResource$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v1/appprofile")();
