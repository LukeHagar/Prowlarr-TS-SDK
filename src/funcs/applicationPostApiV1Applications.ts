...
export function applicationPostApiV1Applications(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostApiV1ApplicationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v1/applications")();
