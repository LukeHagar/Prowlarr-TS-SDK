...
export function indexerProxyPutApiV1IndexerproxyId(
  client: ProwlarrCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutApiV1IndexerproxyIdRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.IndexerProxyResource, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/v1/indexerproxy/{id}")(pathParams);
